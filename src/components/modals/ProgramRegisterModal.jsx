...
export const ProgramRegisterModal = props => {
    ...
    const sendHandler = async() => {
        ...
        try {
            await Api.programs.registerToProgram({classId: eventId, user: registerData});
                    ...
                    {registerConfirmed ? (
                       ...
                       <div className={styles.form}>
                            <TextField
                                ...
                                margin="normal"
                                name="email"
                                label={data.modals.programRegister[lang].email}
                                type="email"
                                fullWidth
                                required
                            ...
                            />
                              <TextField
                                margin="normal"
                                name="name"
                                label={data.modals.programRegister[lang].name}
                                type="text"
                                fullWidth
                                required
                            ...
                            />
                             <TextField
                                margin="normal"
                                name="phone"
                                label={data.modals.programRegister[lang].phone}
                                type="phone"
                                fullWidth
                                required
                            ...
                            />
                             <TextField
                                margin="normal"
                                name="children"
                                label={data.modals.programRegister[lang].children}
                                type="text"
                                fullWidth
                                required
                                multiline
                            ...
                            />
                             <TextField
                                margin="normal"
                                name="reason"
                                label={data.modals.programRegister[lang].reason}
                                type="text"
                                fullWidth
                                required
                                multiline
                            ...
                            />
                             <TextField
                                margin="normal"
                                name="sourse"
                                label={data.modals.programRegister[lang].sourse}
                                type="text"
                                fullWidth
                                multiline
                                rows={2}
