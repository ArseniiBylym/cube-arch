                    ...
                    {registerConfirmed ? (
                       ...
                       <div className={styles.form}>
                            <TextField
                                ...
                                margin="normal"
                                name="email"
                                label={data.modals.tourRegister[lang].email}
                                type="email"
                                fullWidth
                                required
                            ...
                            />
                              <TextField
                                margin="normal"
                                name="name"
                                label={data.modals.tourRegister[lang].name}
                                type="text"
                                fullWidth
                                required
                            ...
                            />
                             <TextField
                                margin="normal"
                                name="phone"
                                label={data.modals.tourRegister[lang].phone}
                                type="phone"
                                fullWidth
                                required
                            ...
                            />
                             <TextField
                                margin="normal"
                                name="children"
                                label={data.modals.tourRegister[lang].children}
                                type="text"
                                fullWidth
                                required
                                multiline
                            ...
                            />
                             <TextField
                                margin="normal"
                                name="reason"
                                label={data.modals.tourRegister[lang].reason}
                                type="text"
                                fullWidth
                                required
                                multiline
                            ...
                            />
                             <TextField
                                margin="normal"
                                name="sourse"
                                label={data.modals.tourRegister[lang].sourse}
                                type="text"
                                fullWidth
                                multiline
                                rows={2}
