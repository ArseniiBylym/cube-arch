            ...
            pages: {
                home: {
                    ...
                    screens: [
                        ...
                        {index: 4, name: "майстер-класи", linkText: `Обрати майстер-клас`, linkUrl: "/classes", header: `Архітектурні майстер-класи для дітей`, text: `Двогодиний майстер-клас — це можливість швидко познайомитися з однією цікавою архітектурною темою і одразу застосувати знання на практиці.\nДіти можуть спробувати себе в ролі архітектора, містопланувальника, майстра вітражів, конструктора, дизайнера…`},
