            ...
            pages: {
                home: {
                    ...
                    screens: [
                        ...
                        {index: 1, name: "інфо", nextScreenTitle: `Що ми пропонуємо?`, header: `Яку користь дає дітям архітектура?`, subHeader: `На наших архітектурних заняттях ваша дитина розвиває навички, які допоможуть їй досягти успіху в майбутньому:`, text: [
                            {
                                title: `Креативність`,
                                subtitle: `Архітектура — це і наука, і мистецтво. Дитина вчиться і фантазувати, і логічно мислити, гармонійно розвиває і праву, і ліву півкулю мозку.`
                            },
                            {
                                title: `Робота в команді`,
                                subtitle: `Створення архітектурного проєкту вимагає зусиль багатьох людей. Дитина вчиться взаємодіяти з іншими задля спільного успіху.`
                            },
                            {
                                title: `Презентація`,
                        ...
                        {index: 3, name: "курси", nextScreenTitle: `Мало часу? Спробуйте короткі майстер-класи`, linkText: `Вибрати курс`, linkUrl: "/courses", header: `Архітектурні курси для дітей`, text: `Серії з 8-12 занять, які допоможуть глибоко і максимально швидко зрозуміти певну архітектурну тему, наприклад:\n— Перші кроки в архітектурі\n— Архітектурне проектування\n— Урбан-дизайн\n— Міні-будівництво\n— Скетчінг\nта інші.`},
                        {index: 4, name: "майстер-класи", linkText: `Вибрати майстер-клас`, linkUrl: "/classes", header: `Архітектурні майстер-класи для дітей`, text: `Двогодиний майстер-клас — це можливість швидко познайомитися з однією цікавою архітектурною темою і одразу застосувати знання на практиці.\nДіти можуть спробувати себе в ролі архітектора, містопланувальника, майстра вітражів, конструктора, дизайнера…`},
                        ...
                        {index: 6, name: "екскурсії", linkText: "Обрати екскурсію", linkUrl: "/tours", header: `Архітектурні екскурсії Києвом для дітей`, text: `Погляньте на місто очима архітектора та дізнайтеся цікаві архітектурні історії про будинки, площі та вулиці.`},
