...
const TourDetails = props => {
    ...
    const fetchCurrentTour = async () => {
        try {
            const doc = await Api.tours.getTour(props.match.params.id);
            if (doc.exists) {
    ...
    if (!content || !tour) return <Spinner />;
    const {
        id,
        datetime,
        description,
    ...
    return (
        <>
                        ...
                        <div className={styles.buttons}>
                            <div className={styles.register}>
                                {open ? (
                                    ...
                                    <div className={styles.register__closed}>
                                        {content.details.closed}
                                    </div>
                                )}
                            </div>
            ...
            <ClassRegisterModal
                ...
                {...{eventId: id, eventName: name, datetime}}
            />
            <ClassOrderModal
                open={orderModal}
